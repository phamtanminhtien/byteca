...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        ...
        <div class="content">
            <h4 class="motto">Simplest link shortened ever. Shorten the link now.</h4>
            <div class="subscribe">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 col-sm6-6 col-sm-offset-3 ">
                        <form class="form-inline" role="form">
                          <div class="form-group">
                            ...
                            <input id="link" type="text" class="form-control transparent" placeholder="Your link here...">
                          </div>
                          <button id="submit" type="submit" class="btn btn-danger btn-fill">Get Link</button>
                        </form>
						...
						<div class="infolink">
							<div class="row">
								<div class="link col col-lg-8">
									<a href="" id="showlink"></a>
									<label class="iv">Invalid link!</label>
									<span id="coppy">
											<i class="fa fa-clone"></i>
									</span>

								</div>
								<div class="qrcode col col-lg-4"><img class="" id="qrcode" src=""/></div>
							</div>
						</div>
        </div>
    </div>
    <div class="footer">
      <div class="container">
             Made with <i class="fa fa-heart heart"></i> by <a href="https://phamtanminhtien.github.io/">Minh Tien</a>.
      </div>
    </div>
 </div>
 </body>
			 ...
			 $.post("ajax.php",{
				 ...
				 if(data == -1){
				   $("#showlink").text("");
					 ...
					 $(".iv").hide();
					 $("#showlink").attr("href", "https://localhost/byteca/"+link.value);
					 $("#showlink").text("https://localhost/byteca/"+link.value);
					 $("#qrcode").attr("src", "http://chart.googleapis.com/chart?cht=qr&chs=300x300&chl=https://localhost/byteca/"+ link.value);
					 $(".infolink").slideDown();
					 $("#coppy").show();
				 }
			 });
